...
const MealDetailSheet = () => {
    ...
    console.log(selectedMealItem);

    const NUTRIENTS = [
        { key: '칼로리', value: selectedMealItem.calories || 0, standard: goalData?.daily_calories || 0, unit: 'kcal' },
        { key: '탄수화물', value: selectedMealItem.carbohydrate || 0, standard: goalData?.daily_carb || 0, unit: 'g' },
        { key: '단백질', value: selectedMealItem.protein || 0, standard: goalData?.daily_protein || 0, unit: 'g' },
        { key: '지방', value: selectedMealItem.fat || 0, standard: goalData?.daily_fat || 0, unit: 'g' },
    ];
        ...
        <BottomSheet onClose={onClose} isOpen={isOpen}>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className={styles.header}>
                    ...
                    <Text size="sm">{selectedMealItem.serving_size ? selectedMealItem.serving_size : ''}</Text>
                </div>
