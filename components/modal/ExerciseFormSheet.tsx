...
const ExerciseFormSheet = () => {
    const { addExercise, exerciseItem } = useExercisesStore();
    ...
    console.log('선택한 운동', exerciseItem);
...
// const ExerciseFormSheet = () => {
//     const [selectedIntensity, setSelectedIntensity] = useState<ExerciseIntensityKeysType | null>(null);
//     const { isOpen, onClose } = useModal(ModalType.exerciseForm);
//     const { addExercise, exerciseItem } = useExercisesStore();
