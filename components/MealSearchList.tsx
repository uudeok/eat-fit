...
const MealSearchList = ({ keyword }: { keyword: string }) => {
    ...
    const {
        ...
        getNextPageParam: (lastPage) => {
            ...
            return lastPage.pageNum < totalPages ? lastPage.pageNum + 1 : undefined;
        },
        select: (data) => {
            const flatData = data.pages.flatMap((page) => page.foodList);
            return flatData;
        },
    });
    ...
    return (
        <>
            <ul className={styles.layout}>
                {searchDatas?.map((item: DecodeFoodDataType) => (
                    <ListRow
...
// import { fetchFoodSearchResults } from '@/service/api/foodDataApi';
// import EmptyState from './common/EmptyState';
// import { ScrollToTop } from './common/Button/ScrollTopButton';
